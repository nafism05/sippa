  ...
  <div class="row">
    <div class="col-sm-10 col-sm-offset-1">
      ...
      <div class="box box-info">
        ...
        <!-- /.box-header -->
        <div class="box-body">
          Data Anda Berhasil Diinput Oleh Sistem.
        </div>
        <div class="box-footer">
          <a href="<?php echo base_url('home'); ?>" class="btn btn-info" role="button"><i class="fa fa-arrow-left" aria-hidden="true"></i> Kembali ke Home</a>
        </div>
      </div>
      <!-- /.box -->
